...
test('an empty preference list or no declared locales resolves to the fallback', () => {
...
// (formatList and isOne are thin wrappers over Intl.ListFormat and
// Intl.PluralRules — asserting their output would test Node's ICU data,
// not this module.)
